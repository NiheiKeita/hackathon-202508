      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-accent/10 to-secondary/20 py-20">
        ...
        <div className="container relative mx-auto px-4 text-center">
          <div className="mb-8 flex justify-center">
            <div className="spirit-glow rounded-full bg-primary p-4">
              <TreePine className="h-12 w-12 text-white" />
            </div>
          </div>
          
          <h1 className="mb-4 bg-gradient-to-r from-primary to-accent bg-clip-text text-6xl font-bold text-transparent">
            KODAMA
          </h1>
        ...
        {/* 背景の装飾的エフェクト */}
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-primary via-accent to-primary opacity-30"></div>
      </section>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card className="group border-primary/20 bg-white/50 backdrop-blur-sm transition-all hover:border-primary/40 hover:shadow-lg">
