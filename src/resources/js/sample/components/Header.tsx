    ...
    <header className="sticky top-0 z-50 border-b border-primary/20 bg-white/90 backdrop-blur-sm">
      <div className="mx-auto max-w-6xl px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="spirit-glow h-10 w-10 overflow-hidden rounded-xl transition-transform group-hover:scale-105">
              <img 
                src={kodamaIcon} 
                alt="KODAMA" 
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">木霊 - 音の森</p>
            </div>
          </div>
